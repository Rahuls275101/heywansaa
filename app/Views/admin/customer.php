	<div class="ec-content-wrapper">
				<div class="content">
					<div class="breadcrumb-wrapper breadcrumb-contacts">
						<div>
							<h1>All User </h1>
							<p class="breadcrumbs"><span><a href="#">User</a></span>
...
<script>
    ...
    var table = $('#ajax_table').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": "<?php echo base_url('admin/customerlist'); ?>",
            "type": "POST",
            "data": function(data) {
    ...
    "buttons": [
        {
            ...
            title: 'customer_' + new Date().toLocaleDateString(), // Custom file name (e.g., "Custom_Filename_02/06/2025.xlsx")
            exportOptions: {
