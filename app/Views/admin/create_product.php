...
?> 
					...
					<div class="breadcrumb-wrapper breadcrumb-contacts">
						<div>
							...
							<p class="breadcrumbs"><span><a href="index.html">Home</a></span>
								<span><i class="mdi mdi-chevron-right"></i></span>Add new Product
							</p>
						</div>
 ...
 <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <div class="mb-3">
                    <textarea class="ckeditor" placeholder="Enter Description" style="width: 100%; height: 300px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" name="description" id="description">
                  ...
                  <div class="form-group">
                    ...
                    <div class="mb-3">
                    <textarea class="ckeditor" placeholder="Enter Additional Information" style="width: 100%; height: 300px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" name="additional_information" id="additional_information">
                  ...
                  <input type="text" class="form-control" value="" name="meta_keyword" required> 
                  </div>
                  </div>
                  ...
                  <input type="text" class="form-control" value="" name="meta_description" required> 
                  </div>
                  </div>
                  </div>
...
<input type="file" name="primary_image" class="image-upload " accept="image/*" />
