					...
					<div class="row g-0">
						<div class="col-lg-6">
							<div class="login_area_left_wrapper">
															    <div class="mylogo"><img src="<?php echo base_url('assets/img/'); ?>/<?php echo $webdetails->header_logo; ?>" alt=""  ></div>
...
<p>At Heywansaa, we understand the modern consumer's yearning for convenience, variety, and quality. That's why we've meticulously curated an extensive collection of products across a multitude of categories, ensuring there's something to cater to every taste and preference.
  ...
  <form action="<?php echo base_url('admin/admin_login'); ?>" method="post" class="modern-login-form">
    
    <h3 class="login-heading">Welcome Back!</h3>
    <p class="login-subheading">Sign in to continue to <span class="brand-name">Heywansaa</span></p>

    <div class="form-group">
      <label for="email">User Name</label>
      <input type="email" class="modern-input" name="email" placeholder="Enter username" required>
    </div>

    <div class="form-group">
      <label for="password">Password</label>
      <input type="password" class="modern-input" name="password" placeholder="Enter password" required>
    </div>
    ...
    <div class="divider">
      <span>New to Vendor</span>
    </div>

    <a href="<?php echo base_url('vender_register'); ?>" class="btn register-btn w-100">Register</a>
  </form>
</div>
							</div>
						</div>
