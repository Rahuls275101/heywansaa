  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h5 class="m-0 text-dark">Create new Franchise  </h5>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <div class="row">
        <div class="col-12">
          ...
          <?php if(session()->getFlashdata('failed')):?>
            ...
            <!-- /.card-header -->
                <form method="POST" action="<?php echo base_url('admin/create_franchise_process'); ?>" enctype="multipart/form-data">
                <div class="card-body">
                   <div class="row">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" required class="form-control" name="number" value="">
                  </div>
                  </div>
                     <div class="col-md-3">
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" required class="form-control" name="time" value="">
                  </div>
                  </div>
                   <div class="col-md-3">
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" required class="form-control" name="franchise_discount" value="">
                  </div>
                  </div>
			  <div class="col-md-6">
                  <div class="form-group">
