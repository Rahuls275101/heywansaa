               ...
               <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <?php foreach($brand as $brandrow) { ?>
                                                    <option value="<?php echo $brandrow->brand_id; ?>" <?php if($brandrow->brand_id==$product->product_brand) { echo "selected"; } ?> ><?php echo $brandrow->brand_name; ?></option>
                                                <?php } ?>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text"  class="form-control" name="max_price" value="<?php echo $product->product_max_price; ?>">
                  </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text"  class="form-control" name="price" value="<?php echo $product->product_price; ?>">
                  </div>
                  </div>
                  
                 <div class="col-md-3">
                  <div class="form-group">
                    <label for="exampleInputPassword1">Inclusive GST*</label>
                    <select class="form-control" required name="inclusive_gst">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number"  class="form-control" name="quantity" id="quantity" value="<?php echo $product->quantity; ?>">
                  </div>
                  </div>
                   <div class="col-md-3">
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text"  class="form-control" name="gst" value="<?php echo $product->gst; ?>">
                  </div>
                  </div>
                  
                   <div class="col-md-3">
                  <div class="form-group">
                    <label for="exampleInputEmail1"> Collections </label>
                                   <select class="select2 select2-hidden-accessible" multiple="" data-placeholder="Select Collections" style="width: 100%;"  name="collections[]">
                                  <?php

                                    foreach ($collections as $collectionsrow) { ?>
                                        <option value="<?php echo $collectionsrow->collections_id; ?>" 
                                            <?php echo in_array($collectionsrow->collections_id,  explode(', ', $product->product_collections)) ? 'selected' : ''; ?> 
                                           >
                                            <?php echo $collectionsrow->collections_name; ?>
                                        </option>
                                    <?php } ?>
                                </select>
                  </div>
                   ...
                   <div class="col-md-12">   
                        ...
                        <div class="group_wrapper">
                             <input type="hidden" name="groupcount" id="groupcount" value="0">
                               <div class="col-md-6">
                  <div class="form-group">
                    <label for="exampleInputPassword1">Select Variant</label>
                    <select class="form-control add_group"  name="add_v">
                    <option value="">Select Variant</option>
                    <?php foreach($main as $mainrow) { ?>
                                                    <option value="<?php echo $mainrow->attribute_main_id; ?>" ><?php echo $mainrow->attribute_main_name; ?></option>
                                                <?php } ?>
                    <option value="add">Add Variant</option>
                    </select> 
                  </div>
                  </div>
...
<div class="col-md-6">
        ...
        <div class="group_wrapper">
            ...
            <table class="table">
                ...
                <tbody class="field_wrapper">
                    <tr class="item-group">
                        <td>
                            <input type="text" class="form-control group-name" placeholder="Group name" 
                                name="group_edit_<?php echo $pro_grouprow->pro_group_id; ?>" 
                                value="<?php echo $pro_grouprow->pro_group_name; ?>">
                        </td>
                    </tr>
                    
                    <?php
                    // Fetch pro_item based on pro_group_id
                    $pro_item = $commanmodel->all_multiple_query_order_by(
                        'pro_item',
                        ['pro_item_group_id' => $pro_grouprow->pro_group_id],
                        'pro_item_id',
                        'ASC'
                    );

                    // Extract pro_item_ids and check for integer consistency
                    $pro_item_ids = array_column($pro_item, 'pro_item_name');
                    $is_int_array = count(array_filter($pro_item_ids, 'is_numeric')) === count($pro_item_ids);

                    // Check if the items exist and are all integers
                    $shoee = $commanmodel->check_select_input($pro_item_ids);
                    $pr = 1;

                    if ($shoee > 0 && $is_int_array) {
                    
                    
                    ?>
                        <tr class="item">
                            <td>
                                <select class="select2 select2-hidden-accessible item-name item-name_updtae" multiple="" data-placeholder="Select amenities" style="width: 100%;"  name="item_edit_<?php echo $pro_grouprow->pro_group_id; ?>[]">
                                    <?php
                                    $amenitiesone = $commanmodel->get_single_query('attributes', [
                                        'attributes_id' => $pro_item_ids[0]
                                    ]);

                                    $attributessec = $commanmodel->all_multiple_query_order_by(
                                        'attributes',
                                        ['attributes_status' => 'Active', 'main_id' => $amenitiesone->main_id],
                                        'attributes_id',
                                        'ASC'
                                    );

                                    foreach ($attributessec as $attributesrow) { ?>
                                        <option value="<?php echo $attributesrow->attributes_id; ?>" 
                                            <?php echo in_array($attributesrow->attributes_id, $pro_item_ids) ? 'selected' : ''; ?> 
                                            data-color="<?php echo $attributesrow->attributes_symbol; ?>" 
                                            data-name="<?php echo $attributesrow->attributes_name; ?>" 
                                            data-id="<?php echo $attributesrow->attributes_id; ?>">
                                            <?php echo $attributesrow->attributes_name; ?>
                                        </option>
                                    <?php } ?>
                                </select>
                            </td>
                    ...
                    <?php } else {
                        // Render input fields for each pro_item
                        foreach ($pro_item as $pro_itemrow) { ?>
                            <tr class="item">
                                <td>
                                    <input type="text" class="form-control item-name variant-<?php echo $pro_grouprow->pro_group_name; ?>" 
                                        placeholder="Item name" 
                                        name="item_edit_<?php echo $pro_itemrow->pro_item_id; ?>" 
                                        value="<?php echo $pro_itemrow->pro_item_name; ?>">
                                </td>
                                <td>
                                    <?php if ($pr == 1) { ?>
                                        Delete 
                                        <input type="checkbox" name="item_delete_<?php echo $pro_itemrow->pro_item_id; ?>" value="Yes">
                                        <button type="button" class="add_button_edit btn btn-sm btn-primary" 
                                            data-fild_id="<?php echo $pro_grouprow->pro_group_id; ?>" title="Add field">
    ...
    <?php } ?>
                ...
                <td></td>
                    ...
                    foreach($pro_variant as $pro_variantrow) { ?>
                                  <tr class="item-group-<?php echo $pro_variantrow->varian; ?>">
                <td> <?php echo $pro_variantrow->varian; ?><input type="hidden" class="form-control" placeholder="0.00" name="variant_<?php echo $pro_variantrow->pro_variant_id; ?>" value="<?php echo $pro_variantrow->varian; ?>"></td>
                <td><input type="text" class="form-control addprice" placeholder="0.00"  id="vprice" name="variant_price_<?php echo $pro_variantrow->pro_variant_id; ?>" data-variant="<?php echo $pro_variantrow->varian; ?>" value="<?php echo $pro_variantrow->pro_variant_price; ?>"></td>
                <td><input type="number" class="form-control addAvailable" placeholder="0" name="variant_available_<?php echo $pro_variantrow->pro_variant_id; ?>" data-variant="<?php echo $pro_variantrow->varian; ?>" value="<?php echo $pro_variantrow->pro_variant_available; ?>"></td>
            <td>
                <input type="hidden" class="form-control addVImage" placeholder="0" name="variant_images_<?php echo $pro_variantrow->pro_variant_id; ?>" data-variant="<?php echo $pro_variantrow->varian; ?>" value="<?php echo $pro_variantrow->pro_variant_image; ?>">
 ...
 <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <div class="mb-3">
                    <textarea class="ckeditor" placeholder="Enter Description" style="width: 100%; height: 300px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" name="description" id="description"><?php echo $product->product_description; ?></textarea>
                    </div>
                  </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="mb-3">
                    <textarea class="ckeditor" placeholder="Enter Additional Information" style="width: 100%; height: 300px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" name="additional_information" id="additional_information"><?php echo $product->additional_information; ?></textarea>
                    </div>
                  </div>
                  </div>
                       ...
                       <div class="col-md-12">
                  <h4>Meta tag for this Product</h4>
                  </div> 

                  <div class="col-md-12">
                  <div class="form-group">
                    <label for="exampleInputPassword1">Meta Title</label>
                  <input type="text" class="form-control" value="<?php echo $product->product_meta_title; ?>" name="meta_title"> 
                  </div>
                  </div>
                  ...
                  <input type="text" class="form-control" value="<?php echo $product->product_meta_keyword; ?>" name="meta_keyword" required> 
                  </div>
                  </div>
                  ...
                  <input type="text" class="form-control" value="<?php echo $product->product_meta_description; ?>" name="meta_description" required> 
                  </div>
                  </div>
                  </div>
        ...
        <div class="col-md-3 imagebox">
            ...
            <div class="form-group form-float">
                <div class="form-line"><label for="exampleInputEmail1">Default</label>
                    <div class="box">

                        <div class="js--image-preview" style="background-image: url(<?php echo base_url('assets/images/'.$product->product_thumbnail.''); ?>)">
                           <i  di class="fas fa-trash-alt imageremove boximage" data-delete="No" ></i>
                        </div>
                        <div class="upload-options"><label>

        <input type="file" name="defaultimage" class="image-upload " accept="image/*" />
	 <input type="hidden" value="<?php echo $product->product_thumbnail; ?>" name="primary_image_old">
...
<?php foreach($product_image as $imagesrow) { ?>
        <div class="col-md-3 imagebox">

            
            <div class="form-group form-float">
                <div class="form-line"><label for="exampleInputEmail1">Image</label>
                    <div class="box">

                        <div class="js--image-preview" style="background-image: url(<?php echo base_url('assets/images/'.$imagesrow->product_image_url.''); ?>)">
                           <i class="fas fa-trash-alt imageremove boximage" data-delete="Yes"></i>
                        </div>
                        <div class="upload-options"><label>

<input type="file" name="productimage_<?php echo $imagesrow->product_image_id; ?>" class="image-upload " accept="image/*" />
<input type="text" name="fileimage_<?php echo $imagesrow->product_image_id; ?>" value="yes" />
                        </label></div>
...
<?php } ?>          
                            ...
                            <button id="addimage" type="button"class="btn btn-primary">Add Image</i> </button>
                            <p>Image resolution should be like 640px X 640px</p>
                        </div>
                    </div>
