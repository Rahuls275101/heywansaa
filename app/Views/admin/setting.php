...
<div class="col-md-12 mt-4">
    <hr>
    <h5 class="f-w-600">Warehouse Details</h5>
</div>

<div class="col-md-6">
    <div class="form-group">
        <label for="warehouse_name">Warehouse primary Name (Unique)</label>
        <input type="text" class="form-control" name="warehouse_primary_name" value="<?php echo $userdetails->warehouse_primary_name ?? 'Primary'; ?>">
    </div>
</div>
...
<div class="col-md-6">
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="warehouse_name" value="<?php echo $userdetails->warehouse_name ?? ''; ?>">
    </div>
</div>
...
<div class="col-md-6">
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="warehouse_phone" value="<?php echo $userdetails->warehouse_phone ?? ''; ?>">
    </div>
</div>
...
<div class="col-md-6">
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="warehouse_address" value="<?php echo $userdetails->warehouse_address ?? ''; ?>">
    </div>
</div>

<div class="col-md-6">
    <div class="form-group">
        <label for="warehouse_address_2">Warehouse Address 2</label>
        <input type="text" class="form-control" name="warehouse_address_2" value="<?php echo $userdetails->warehouse_address_2 ?? ''; ?>">
    </div>
</div>
...
<div class="col-md-4">
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="warehouse_city" value="<?php echo $userdetails->warehouse_city ?? ''; ?>">
    </div>
</div>
...
<div class="col-md-4">
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="warehouse_state" value="<?php echo $userdetails->warehouse_state ?? ''; ?>">
    </div>
</div>

<div class="col-md-4">
    <div class="form-group">
        <label for="warehouse_pincode">Pincode</label>
        <input type="text" class="form-control" name="warehouse_pincode" value="<?php echo $userdetails->warehouse_pincode ?? ''; ?>">
    </div>
</div>
