												...
												<table class="table table-striped o-tbl">
													...
													<tbody>
														<tr>
															...
															<td><img class="product-img tbl-img" style="
    width: 57px;
" src="<?php echo $item->booking_product_image; ?>" ></td>
     ...
     $shupnow = false; ?>                     
          <table class="table table-bordered table-striped">
                ...
                <tr>
                  <th>Ship Order Id </th>
                  <th><?php echo $item->ship_order_id; ?></th>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <th> <?php echo $item->ship_status; ?></th>
                    ...
                    <tr>
                  <th>Ship Status</th>
                  <th>  <a class="btn btn-flat btn-success" href="<?php echo base_url().'/track-xpressbees-shipment/'.$item->booking_product_order_id ; ?>">Track</i></a></th>
                </tr>
