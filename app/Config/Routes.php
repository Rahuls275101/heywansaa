...
$routes->get('/bulk-order', 'Home::bulk_order');
$routes->get('/friend-family', 'Home::friend_family');
 ...
 */
 ...
 $routes->get('/track-xpressbees-shipment/(:any)', 'Admin::track_xpressbees_shipment/$1');
