                      ...
                      foreach ($pagelist as $catKey => $pageVal) {
                        ...
                        <tr>
                          <td class="checkbox-column text-left"> 
                            <label class="new-control new-checkbox checkbox-outline-info  m-auto">
                              <input type="checkbox" type="checkbox" name="arr_ids[]" value="<?php echo $pageVal['customers_id']; ?>" class="new-control-input child-chk select-customers-info">
                              <span class="new-control-indicator"></span><span style="visibility:hidden">c</span>
                            </label>                            
                          </td>
                          <td>
                        <b>Name : </b><?php echo $pageVal['name']; ?><br />
                        <b>Mobile : </b><?php echo $pageVal['mobile_number']; ?>
                      </td>
                      <td>
                        <b>Username : </b><?php echo $pageVal['user_name']; ?><br />
                        <b>Password : </b><?php echo $pageVal['password']; ?>
                      </td>
                      <td><b>Address: </b><?php echo $addres[0]['address']; ?><br/><b>Pin:</b> <?php echo $addres[0]['zipcode']; ?><br/><b>State:</b> <?php echo $addres[0]['state']; ?><br/><b>Country:</b> <?php echo $addres[0]['country']; ?></td>
