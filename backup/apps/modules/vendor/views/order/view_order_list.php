          ...
          <div class="statbox widget box box-shadow">
            ...
            <div class="widget-header">
              <div class="row">
                ...
                <div class="col-sm-9">
                    <form class="row" action="<?php echo base_url().'wps-vendor/orders/filterorderhistorybydate'; ?>" method="get">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>From Date</label>
                                <input type="date" class="form-control session-date" name="fromdate"   value="<?php if(set_value('fromdate')){ echo set_value('fromdate'); }else{ echo $this->input->get('fromdate'); } ?>">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>To Date</label>
                                <input type="date" class="form-control session-date" name="todate"    value="<?php if(set_value('todate')){ echo set_value('todate'); }else{ echo $this->input->get('todate'); } ?>">
                            </div>
                        </div>
                        <div class="col-md-4">
            ...
            <div class="widget-content widget-content-area">
              <div class="table-responsive mb-4">
                ...
                if (is_array($neworders) && !empty($neworders)) {
                  echo form_open("", 'id="data_form"');
                  ?>
                  <table id="pagination" class="">
                    <thead>
                      <tr>
                    ...
                    <tbody>
                      ...
                      $sl = 1;
                      foreach ($neworders as $n=> $pageVal) {
                        ?> 
                        <tr>
 ...
 <?php } $i++; } ?>
                          ...
                          <td align="left">
                            ...
                            if ($pageVal['payment_status'] == 'Unpaid') {
                              ?>
                              <!--<strong><a onclick="return confirm('Are you sure you want to make this order paid');" href="<?php echo base_url(); ?>wps-vendor/orders/make_paid/<?php echo $pageVal['order_id']; ?>" >Mark as Paid</a></strong>-->
                              <?php
                            }
                            ?>
                            <br /><br />
