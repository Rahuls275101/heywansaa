...
<script>
    const noimage="https://kerrys.co.in/demo/heywansa/uploaded-files/thumb-cache/thumb_125_125_noimage.jpg";
</script>
      ...
      <div class="row layout-top-spacing layout-spacing">
        <div class="col-lg-12">
          <div class="statbox widget box box-shadow">
            <?php
            echo form_open_multipart('wps-vendor/products/add/', 'id="data_form"');
            ...
            <div class="widget-header">
              <div class="row">
                ...
                <div class="col-xl-6 col-md-6 col-sm-6 col-6 text-right">
                  <h4>
                    <a href="<?php echo base_url(); ?>wps-vendor/products/index/" class="btn btn-danger btn-sm mb-2"><i class="fa fa-exclamation-circle"></i> Cancel</a>
            ...
            <div class="widget-content widget-content-area">
              ...
              <div class="form-group row  mb-4">
                ...
                <div class="form-group row  mb-4">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="url_creator form-control" id="product_name" name="product_name" value="<?php echo set_value('product_name'); ?>" placeholder="Product Name" required /><?php echo form_error('product_name'); ?>
                ...
                <div class="form-group row  mb-4">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="seo_friendly_url form-control" id="friendlyUrl" name="friendly_url" value="<?php echo set_value('friendlyUrl'); ?>" readonly required /><?php echo form_error('friendlyUrl'); ?>
              ...
              <div class="col-md-2">
                <div class="">
                    <span class="btn-danger position-absolute p-2" onclick='$("#pic1").attr("src",noimage); $("#img1").val(null)'>X</span>
                  <img src="<?php echo get_image('products', '', '125', '125', 'R'); ?>" id="pic1" class="profile_picture" width="125" height="125"  /><div class="clearfix"></div>
              ...
              <div class="col-md-2">
                <div class="">
                    <span class="btn-danger position-absolute p-2" onclick='$("#pic2").attr("src",noimage); $("#img2").val(null)'>X</span>
                  <img src="<?php echo get_image('products', '', '125', '125', 'R'); ?>" id="pic2" class="profile_picture" width="125" height="125" /><div class="clearfix"></div>
              ...
              <div class="col-md-2">
                <div class="">
                    <span class="btn-danger position-absolute p-2" onclick='$("#pic3").attr("src",noimage); $("#img3").val(null)'>X</span>
                  <img src="<?php echo get_image('products', '', '125', '125', 'R'); ?>" id="pic3" class="profile_picture" width="125" height="125" /><div class="clearfix"></div>
              ...
              <div class="col-md-2">
                <div class="">
                    <span class="btn-danger position-absolute p-2" onclick='$("#pic4").attr("src",noimage); $("#img4").val(null)'>X</span>
                  <img src="<?php echo get_image('products', '', '125', '125', 'R'); ?>" id="pic4" class="profile_picture" width="125" height="125" /><div class="clearfix"></div>
                ...
                <div class="form-group row  mb-4">
                  ...
                  <div class="col-sm-6 row">
                    <div class="col-sm-6">
                    <input id="product_price" name="product_price" value="<?php echo set_value('product_price'); ?>" type="text" required class="form-control" placeholder="MRP Price"><?php echo form_error('product_price'); ?>
                    <label for="product_code"><span class="required">*</span>Product Price</label>
                    </div>
                    <div class="col-sm-6">
                    <input id="unit_value" name="discounted_price" value="<?php echo set_value('discounted_price'); ?>" type="text" required class="form-control"  placeholder="Discounted Price"><?php echo form_error('discounted_price'); ?>
                ...
                <div class="form-group row  mb-4">
                  ...
                  <div class="col-sm-9 row">
                        <div class="col-sm-6">
                            <input id="product_code" name="product_code" value="<?php echo set_value('product_code'); ?>" type="text"  placeholder="SKU Code" class="form-control" required><?php echo form_error('product_code'); ?>
                            <label for="product_code"><span class="required">*</span>SKU Code</label>
                        </div>
                        <div class="col-sm-6">
                            <input id="product_qty" name="product_qty" value="<?php echo set_value('product_qty'); ?>" type="text"  placeholder="Product Quantity"class="form-control" required><?php echo form_error('product_qty'); ?>
                            <label for="product_qty"><span class="required">*</span>Product Qty</label>
                        </div>
                        <div class="col-sm-4">
                            <input id="hsn_code" name="hsn_code" value="<?php echo set_value('hsn_code'); ?>" type="text"  placeholder="HSN Code" class="form-control" required><?php echo form_error('hsn_code'); ?>
                            <label for="hsn_code"><span class="required">*</span>HSN Code</label>
                        </div>
                        <div class="col-sm-4">
                            <input id="tax_rate" name="tax_rate" value="<?php echo set_value('tax_rate'); ?>" type="number"  placeholder="TAX RATE" class="form-control" required><?php echo form_error('tax_rate'); ?>
                            <label for="tax_rate"><span class="required">*</span>Tax Rate (%)</label>
                        </div>
                        <div class="col-sm-4">
                            <input id="cancelation_expiry_days" name="cancelation_expiry_days" value="<?php echo set_value('cancelation_expiry_days'); ?>" type="number"  placeholder="Cancecaltion Expiry Days" class="form-control" required><?php echo form_error('cancelation_expiry_days'); ?>
                ...
                <!-- <div class="form-group row  mb-4">
                  ...
                  <div class="col-sm-6">
                  <input id="product_code" name="youtube_id" value="<?php echo set_value('youtube_id'); ?>" type="text" class="form-control"><?php echo form_error('youtube_id'); ?>
                  </div>
                </div> -->
                ...
                <div class="form-group row  mb-4">
                  ...
                  <div class="col-sm-6">
                  <textarea name="short_desc" rows="5" cols="50" id="short_desc" ><?php echo set_value('short_desc'); ?></textarea> <?php echo form_error('short_desc'); ?>
                  </div>
                </div>
                ...
                <div class="form-group row  mb-4">
                  ...
                  <div class="col-sm-6">
                  <textarea name="description" rows="5" cols="50" id="description" ><?php echo set_value('description'); ?></textarea> <?php echo display_ckeditor($ckeditor1); ?><?php echo form_error('description'); ?>
                  </div>
                </div>
                ...
                <div class="form-group row  mb-4">
                  ...
                  <div class="col-sm-6">
                  <textarea name="specification" rows="5" cols="50" id="specification" ><?php echo set_value('specification'); ?></textarea> <?php echo display_ckeditor($ckeditor2); ?><?php echo form_error('specification'); ?>
                  </div>
                </div>
              ...
              <div class="form-group row  mb-4">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control" id="metaTitle" name="metaTitle" value="<?php echo set_value('metaTitle'); ?>" placeholder="Meta Title" /><?php echo form_error('title'); ?>
                </div>
              </div>
              <div class="form-group row  mb-4">
              ...
              <div class="form-group row  mb-4">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control" id="metaKeyword" name="metaKeyword" placeholder="Meta Keyword" value="<?php echo set_value('metaKeyword'); ?>" /><?php echo form_error('metaKeyword'); ?>
                </div>
              </div>
              
              <!--<div class="form-group row  mb-4">-->
              <!--  <label class="col-sm-3 col-form-label col-form-label-sm" for="metaKeyword">Price Show or Hide</label>-->
              <!--  <div class="col-sm-6">-->
              <!--    <input type="radio" class="" id="hide_show_price" name="hide_show_price" placeholder="Meta Keyword" value="1" /><?php echo form_error('hide_show_price'); ?>  Hide &nbsp;&nbsp;&nbsp;-->
              <!--     <input type="radio" class="" id="hide_show_price" name="hide_show_price" placeholder="Meta Keyword" value="0" checked /><?php echo form_error('hide_show_price'); ?>  Show-->
              <!--  </div>-->
              <!--</div>-->
              <!--<div class="form-group row  mb-4">-->
              <!--  <label class="col-sm-3 col-form-label col-form-label-sm" for="brand">Select Brand</label>-->
              <!--  <div class="col-sm-6">-->
              <!--    <select  id="brand" name="brand" class="form-control" >-->
                      <?php
                    //   foreach($brand as $b2=>$br)
                    //   {
                    //       ?>
                           <!--<option><?php echo $br['brand_name'] ?></option>-->
                           <?php
                    //   }
                      ?>
              <!--    </select>-->
