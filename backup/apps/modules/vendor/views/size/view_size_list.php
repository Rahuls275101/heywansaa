            ...
            <div class="widget-header">
              <div class="row">
                ...
                <div class="col-xl-4 col-md-4 col-sm-4 col-4 text-right">
                  <h4><a href="<?php echo base_url(); ?>wps-admin/size/add" class="btn btn-dark btn-sm mb-2"><i class="fa fa-plus"></i> Add New Size</a></h4>
                </div>
              </div>
            </div>
            <div class="widget-content widget-content-area">
              <div class="table-responsive mb-4">
                ...
                if (is_array($res) && !empty($res)) {
                  echo form_open(base_url() . "wps-admin/size/", 'id="data_form"');
                  ?>
                      ...
                      foreach ($res as $catKey => $pageVal) {
                        ...
                        <tr>
                          <td class="checkbox-column text-left"> 
                            <label class="new-control new-checkbox checkbox-outline-info  m-auto">
                              <input type="checkbox" type="checkbox" name="arr_ids[]" value="<?php echo $pageVal['size_id']; ?>" class="new-control-input child-chk select-customers-info">
                              <span class="new-control-indicator"></span><span style="visibility:hidden">c</span>
                            </label>                            
                          </td>
                          <td>
						<?php echo $pageVal['size_name'];?>
                          ...
                          <td>
                            <a href="<?php echo base_url(); ?>wps-admin/size/edit/<?php echo $pageVal['size_id']; ?>" class="btn btn-success btn-sm mb-2">Edit</a>
                          </td>
                        </tr>
