            ...
            <div class="widget-header">
              <div class="row">
                ...
                <div class="col-xl-4 col-md-4 col-sm-4 col-4 text-right">
                  <h4><a href="<?php echo base_url(); ?>wps-admin/subcontent/add" class="btn btn-dark btn-sm mb-2"><i class="fa fa-plus"></i> Add New Content</a></h4>
                </div>
              </div>
            </div>
            <div class="widget-content widget-content-area">
              <div class="table-responsive mb-4">
                ...
                if (is_array($res) && !empty($res)) {
                  echo form_open(base_url() . "wps-admin/subcontent/", 'id="data_form"');
                  ?>
                    ...
                    <tbody>
                      ...
                      foreach ($res as $catKey => $pageVal) {
                        ...
                        <tr>
                          <td class="checkbox-column text-left"> 
                            <label class="new-control new-checkbox checkbox-outline-info  m-auto">
                              <input type="checkbox" type="checkbox" name="arr_ids[]" value="<?php echo $pageVal['subcontentId']; ?>" class="new-control-input child-chk select-customers-info">
                              <span class="new-control-indicator"></span><span style="visibility:hidden">c</span>
                            </label>                            
                          </td>
                          <td class="left">
                          <?php
                                ...
                                foreach($cat as $cval){
                                  ...
                                  <div class="col-md-3 cols-sm-3">
                                    <?php
                                    echo '<b>('.$slLoc.').</b> '.ucwords(get_db_field_value('wps_categories','category_name',"WHERE category_id = '".$cval."'"));
                                    ?>
                                  </div>
                                  <?php                                  
                                  $slLoc++;
                                ...
                                ?>
                        <!-- <a href="#" data-toggle="modal" data-target=".pro_list_<?php echo $pageVal['subcontentId']; ?>">View Locations</a> -->
                          ...
                          <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                              <div class="modal-header">
                                ...
                                <h4 class="modal-title" id="description">Locations Added</h4>
                              </div>
                              <div class="modal-body">
                                ...
                                foreach($cat as $cval){
                                  ...
                                  <div class="col-md-3 cols-sm-3">
                                    <?php
                                    echo '<b>('.$slLoc.').</b> '.ucwords(get_db_field_value('wps_meta_tags','page_url',"WHERE meta_id = '".$cval."'"));
                                    ?>
                                  </div>
                                  <?php                                  
                                  $slLoc++;
                      ...
                      <td class="left">
                        <?php echo $pageVal['short_description']; ?>
                          ...
                          <td>
                            <a href="<?php echo base_url(); ?>wps-admin/subcontent/edit/<?php echo $pageVal['subcontentId']; ?>" class="btn btn-success btn-sm mb-2">Edit</a>
                          </td>
                        </tr>
