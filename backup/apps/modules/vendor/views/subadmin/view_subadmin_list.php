          ...
          <div class="statbox widget box box-shadow">
            ...
            <div class="widget-header">
              ...
              <div class="row">
                ...
                <div class="col-xl-4 col-md-4 col-sm-4 col-6  text-right">

                  <h4><a href="<?php echo base_url(); ?>wps-admin/subadmin/add/" class="btn btn-dark btn-sm mb-2"><i class="fa fa-plus"></i> Add New Sub Admin</a></h4>
            ...
            <div class="widget-content widget-content-area">
              ...
              <div class="table-responsive mb-4">
                ...
                if (is_array($res) && !empty($res)) {
                  ...
                  echo form_open(base_url() . "wps-admin/subadmin/", 'id="data_form"');
                  ...
                  <table id="style-3" class="table style-3  table-hover">
                    ...
                    <tbody>
                      ...
                      foreach ($res as $catKey => $pageVal) {
                        ...
                        $countnews = $this->db->query("SELECT news_id FROM wps_news WHERE added_by=".$pageVal['admin_id']."")->result_array();
                        ...
                        <tr>
                          ...
                          <label class="new-control new-checkbox checkbox-outline-info  m-auto">
                              ...
                              <input type="checkbox" type="checkbox" name="arr_ids[]" value="<?php echo $pageVal['admin_id']; ?>" class="new-control-input child-chk select-customers-info">
                          ...
                          <td>
                            ...
                            <?php echo $pageVal['name']; ?><br/><a href="<?php echo base_url(); ?>wps-admin/news?added_by=<?php echo $pageVal['admin_id']; ?>" target="_blank" style="color:#e7515a;"><strong>[<?=count($countnews);?> News Posted]</strong></a>

                          </td>

                          <td>

                            <?php echo $pageVal['admin_username']; ?>

                          </td>

                          <td>

                            <?php echo $pageVal['admin_password']; ?>
                            ...
                            if ($pageVal['status'] == '1') {
                              ...
                              <div class="field-wrapper toggle-pass" title="Activated : Deactivate Now">
                                ...
                                <label class="switch s-active">
                                  ...
                                  <input type="checkbox" checked class="d-none toggle-status" data-userId="<?php echo $pageVal['admin_id']; ?>" data-status="0" data-controller="<?php echo $this->router->fetch_class(); ?>">
                              ...
                              <div class="field-wrapper toggle-pass" title="Deactivated : Activate Now">
                                ...
                                <label class="switch s-deactive">
                                  ...
                                  <input type="checkbox" class="d-none toggle-status" data-userId="<?php echo $pageVal['admin_id']; ?>" data-status="1" data-controller="<?php echo $this->router->fetch_class(); ?>">
                          ...
                          <td>
                            ...
                            <a href="<?php echo base_url(); ?>wps-admin/subadmin/edit/<?php echo $pageVal['admin_id']; ?>" class="btn btn-success btn-sm mb-2">Edit</a>
