            ...
            <div class="widget-header">
              <div class="row">
                ...
                <div class="col-xl-6 col-md-6 col-sm-6 col-6 text-right">
                  <h4>
                    <a href="<?php echo base_url(); ?>wps-admin/subadmin/" class="btn btn-danger btn-sm mb-2"><i class="fa fa-exclamation-circle"></i> Cancel</a>
            ...
            <div class="widget-content widget-content-area">
              <div class="table-responsive mb-4">
                ...
                <div class="form-group row  mb-4">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="name" id="name" placeholder="Name" class="form-control" value="<?php echo set_value('name'); ?>"><?php echo form_error('name'); ?>
                  </div>
                </div>
                <div class="form-group row  mb-4">
                  <label class="col-sm-3 col-form-label col-form-label-sm" for="admin_username">Login Username <span class="red">*</span></label>
                  <div class="col-md-6">                                                                                                                                                        
                    <input type="text" name="admin_username" id="admin_username" placeholder="Login Username" class="form-control" value="<?php echo set_value('admin_username'); ?>"><?php echo form_error('admin_username'); ?>
                  </div>
                </div>
                <div class="form-group row  mb-4">
                  <label class="col-sm-3 col-form-label col-form-label-sm" for="admin_password">Login Password <span class="red">*</span></label>
                  <div class="col-md-6 col-xs-12">                                         
                    <input type="password" name="admin_password" id="admin_password" placeholder="Login Password" class="form-control" value="<?php echo set_value('admin_password'); ?>" autocomplete="new-password"><?php echo form_error('admin_password'); ?>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-xl-6 col-md-6 col-sm-6 col-6 text-right">
                    <h4>
                      <a href="<?php echo base_url(); ?>wps-admin/subadmin" class="btn btn-danger btn-sm mb-2"><i class="fa fa-exclamation-circle"></i> Cancel</a>
                      <button type="submit" class="btn btn-primary btn-sm mb-2"><i class="fa fa-plus"></i> Save</button>
                      <input type="hidden" name="action" value="sbmt_cpn" /> 
                    </h4>
                  </div>
                </div>
              </div>
