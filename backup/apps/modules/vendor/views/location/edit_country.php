      ...
      <div class="row layout-top-spacing layout-spacing">
        <div class="col-lg-12">
          <div class="statbox widget box box-shadow">
            <?php
            echo form_open_multipart("wps-admin/location/edit_country/".$res->id, 'id="data_form"');
            ...
            <div class="widget-header">
              <div class="row">
                ...
                <div class="col-xl-6 col-md-6 col-sm-6 col-6 text-right">
                  <h4>
                    <a href="<?php echo base_url(); ?>wps-admin/location/" class="btn btn-danger btn-sm mb-2"><i class="fa fa-exclamation-circle"></i> Cancel</a>
                    <button type="submit" name="submit" class="btn btn-primary btn-sm mb-2"><i class="fa fa-plus"></i> Save</button>                    
                  </h4>
                </div>
              </div>
            </div>
            ...
            <div class="widget-content widget-content-area">
              <div class="table-responsive mb-4">
                ...
                <div class="form-group row  mb-4">
                  ...
                  <div class="col-sm-6">
                    <div id="ban_postion">
                    <input type="text" class="form-control" name="country" value="<?php echo set_value('country', $res->name) ?>"><?php echo form_error('country'); ?>
                    </div>
                  </div>
                </div>
