            ...
            <div class="widget-content widget-content-area">
              <div class="table-responsive mb-4">
                ...
                <div class="form-group row  mb-4">
                  ...
                  <div class="col-sm-6">
                  <select name="state_id" class="form-control" id="state"></select> <?php echo form_error('state'); ?>
                  </div>
                </div>
                ...
                <div class="form-group row  mb-4">
                  ...
                  <div class="col-sm-6">
                    <div id="ban_postion">
                    <input type="text" class="form-control" name="city" id="city">  <?php echo form_error('city'); ?>
                    </div>
                  </div>
                </div>
