            ...
            <div class="widget-header">
              <div class="row">
                ...
                <div class="col-xl-6 col-md-6 col-sm-6 col-6 text-right">
                  <h4>
                    <a href="<?php echo base_url(); ?>wps-admin/subloccontent/" class="btn btn-danger btn-sm mb-2"><i class="fa fa-exclamation-circle"></i> Cancel</a>
            ...
            <div class="widget-content widget-content-area">
              ...
              <?php echo form_error('location_id'); ?>
                ...
                <div class="form-group row  mb-4">
                  ...
                  <div class="col-sm-6">
                  <textarea class="form-control" name="description" id="description"><?php echo set_value('description'); ?></textarea><?php echo form_error('description'); ?><?php echo display_ckeditor($ckeditor); ?><b style="color:#660000;">Contrary to {location} belief.</b>
                  </div>
                </div>
                ...
                <div class="form-group row  mb-4">
                  ...
                  <div class="col-sm-6">
                    <div id="ban_postion">
                    <textarea class="form-control" name="short_description" id="short_description"><?php echo set_value('short_description'); ?></textarea><?php echo form_error('short_description'); ?><b style="color:#660000;">Contrary to {location} belief.</b>
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group row  mb-4">
                  ...
                  <div class="col-sm-6">
                    <div id="ban_postion">
                        <input type="text" class="form-control" name="meta_title" id="title" value="<?php echo set_value('meta_title'); ?>" />
                        <?php echo form_error('meta_title'); ?><b style="color:#660000;">Manufacturer in {location}</b>
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group row  mb-4">
                  ...
                  <div class="col-sm-6">
                    <div id="ban_postion">
                    <textarea class="form-control" name="meta_keyword" rows="5" cols="80" id="keyword" ><?php echo set_value('meta_keyword'); ?></textarea><?php echo form_error('meta_keyword'); ?><b style="color:#660000;">Manufacturer in {location}</b>
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group row  mb-4">
                  ...
                  <div class="col-sm-6">
                    <div id="ban_postion">
                    <textarea class="form-control" name="meta_description" rows="5" cols="80" id="description" ><?php echo set_value('meta_description'); ?></textarea><?php echo form_error('meta_description'); ?><b style="color:#660000;">Manufacturer in {location}</b>
                    </div>
                  </div>
                </div>
