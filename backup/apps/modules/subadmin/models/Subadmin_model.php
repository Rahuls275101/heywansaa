...
class Subadmin_model extends MY_Model {
  ...
  public function getsubadmin($opts = array()) {
    ...
    $opts['condition'] .= " and admin_type='2' ";
    ...
    $result = $this->findAll('wps_admin as a', $fetch_config);
    return $result;
  }
  ...
  public function get_subadmin_by_id($id) {
    ...
    if ($id > 0) {
      $condtion = "status !='2' AND admin_id=$id";
      $fetch_config = array(
          'condition' => $condtion,
          'debug' => FALSE,
          'return_type' => "array"
      );
      $result = $this->find('wps_admin', $fetch_config);
      return $result;
    }
  }
