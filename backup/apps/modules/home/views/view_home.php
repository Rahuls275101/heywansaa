...
<main class="main mt-0">
            <section class="mobile-category-menu">
                <div class="container">
                    <!-- Swiper -->
                    <div class="swiper mobile-category-slide">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="mobile-category-block">
                                   <a href="<?php echo base_url(); ?>"> <img src="<?php echo DESIGN_URL; ?>assets/images/menu/icon.png" alt=""><h3> Home</h3></a> 
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="mobile-category-block">
                                    <a href="<?php echo base_url().'seasonal-delights'; ?>"> <img src="<?php echo DESIGN_URL; ?>assets/images/menu/icon.png" alt=""> <h3>Seasonal Delights</h3> </a>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="mobile-category-block">
                                  <a href="<?php echo base_url().'best-seller'; ?>"> <img src="<?php echo DESIGN_URL; ?>assets/images/menu/icon.png" alt=""><h3>Best sellers</h3> </a>
                                    </a>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="mobile-category-block">
                                     <a href="<?php if($this->session->userdata('user_id')){ echo base_url().'my-orders'; } else { echo base_url().'login';} ?>"> <img src="<?php echo DESIGN_URL; ?>assets/images/menu/icon.png" alt=""><h3>Track Your order</h3></a>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="mobile-category-block">
                                       <a href="<?php echo base_url().'share/friend-family'; ?>"> <img src="<?php echo DESIGN_URL; ?>assets/images/menu/icon.png" alt="">
                                        
                                        <h3>Recommend to family / Friends</h3> </a>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="mobile-category-block">
                                    <a href="<?php echo base_url().'login/vendor'; ?>"> <img src="<?php echo DESIGN_URL; ?>assets/images/menu/seller.png" alt="">
                                        ...
                                        <h3>Become A Seller</h3> </a>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="mobile-category-block">
                                    <a href="#!">
                                          <img src="<?php echo DESIGN_URL; ?>assets/images/menu/icon.png" alt="">
                                        <h3>Category</h3>
                                    </a>
                                </div>
                            </div>
        ...
        <section class="main-section">    
          <div class="home-banner">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4">
                       <img src="<?php echo base_url(); ?>assets/designer/themes/default/assets/images/banner-img.png" alt="logo" />
                    </div>
                    <div class="col-md-8"> 
                        <div class="right">
                             <h1>Recommended by Friend/Family</h1> 
                            <p>Heywansaa is dedicated to providing the ultimate retail experience for you </p> 
                        </div>
                    </div>
                    </div>
                </div>
            ...
            <!--        <div class="swiper-wrapper">-->
            <!--    <?php
                    // foreach($allbanners as $ab=>$slider)
                    // {
                    //     if($slider['banner_position']=='Index Slider')
                    //     {
                ?>
            <!--            <div class="swiper-slide">-->
            <!--                 <img src="<?php // echo base_url().'uploaded-files/banner/'.$slider['banner_image']; ?>" alt="">-->
            <!--            </div>-->
            ...
            <!--    </div>-->
            <!--</section>-->
            <section class="oval-back">
                <video autoplay muted loop>
                    <source src="<?php echo DESIGN_URL; ?>assets/images/oval/bg-video.mp4" type="video/mp4">
                </video>
                <div class="video-overlay"></div>
                <div class="container-fluid">
                    <div class="category-main-box">
                        <div class="category-box c-box-1 animate__animated animate__fadeInUp animate__delay-1s">
                            <!--<div class="bg-circle-background">-->
                            <div class="circle-relative">
                                 <img src="<?php echo DESIGN_URL; ?>assets/images/oval/cat-1/circle.png" alt="" class="big-circle">
                                 <img src="<?php echo DESIGN_URL; ?>assets/images/oval/cat-1/icon.png" alt="" class="big-circle-icon">
                                 <img src="<?php echo DESIGN_URL; ?>assets/images/oval/cat-1/line.png" alt="line.png" class="big-circle-line">
                                <a href="<?php echo $category[0]['friendly_url']; ?>"><?php echo $category[0]['category_name']; ?></a>
                            </div>
                            <!--</div>-->
                        </div>
                        <div class="category-box c-box-2 animate__animated animate__fadeInUp animate__delay-2s">
                            <!--<div class="bg-circle-background align-circle-2">-->
                            <div class="circle-relative">
                                 <img src="<?php echo DESIGN_URL; ?>assets/images/oval/cat-2/circle.png" alt="" class="big-circle">
                                 <img src="<?php echo DESIGN_URL; ?>assets/images/oval/cat-2/icon.png" alt="" class="big-circle-icon">
                                 <img src="<?php echo DESIGN_URL; ?>assets/images/oval/cat-2/line.png" alt="line.png" class="big-circle-line">
                                <a href="<?php echo $category[1]['friendly_url']; ?>"><?php echo $category[1]['category_name']; ?></a>
                            </div>
                            <!--</div>-->
                        </div>
                        <div class="category-box c-box-3 animate__animated animate__fadeInUp animate__delay-3s">
                            <!--<div class="bg-circle-background align-circle-3">-->
                            <div class="circle-relative">
                                 <img src="<?php echo DESIGN_URL; ?>assets/images/oval/cat-3/circle.png" alt="" class="big-circle">
                                 <img src="<?php echo DESIGN_URL; ?>assets/images/oval/cat-3/icon.png" alt="" class="big-circle-icon">
                                 <img src="<?php echo DESIGN_URL; ?>assets/images/oval/cat-3/line.png" alt="line.png" class="big-circle-line">
                                <a href="<?php echo $category[2]['friendly_url']; ?>"><?php echo $category[2]['category_name']; ?></a>
                            </div>
                            <!--</div>-->
                        </div>
                        <div class="category-box c-box-4 animate__animated animate__fadeInUp animate__delay-4s">
                            <!--<div class="bg-circle-background align-circle-4">-->
                            <div class="circle-relative">
                                 <img src="<?php echo DESIGN_URL; ?>assets/images/oval/cat-4/circle.png" alt="" class="big-circle">
                                 <img src="<?php echo DESIGN_URL; ?>assets/images/oval/cat-4/icon.png" alt="" class="big-circle-icon">
                                 <img src="<?php echo DESIGN_URL; ?>assets/images/oval/cat-4/line.png" alt="line.png" class="big-circle-line">
                                <a href="<?php echo $category[3]['friendly_url']; ?>"><?php echo $category[3]['category_name']; ?></a>
                            </div>
                            <!--</div>-->
                        </div>
                        <div class="category-box c-box-5 animate__animated animate__fadeInUp animate__delay-5s">
                            <!--<div class="bg-circle-background align-circle-5">-->
                            <div class="circle-relative">
                                 <img src="<?php echo DESIGN_URL; ?>assets/images/oval/cat-5/circle.png" alt="" class="big-circle">
                                 <img src="<?php echo DESIGN_URL; ?>assets/images/oval/cat-5/icon.png" alt="" class="big-circle-icon">
                                 <img src="<?php echo DESIGN_URL; ?>assets/images/oval/cat-5/line.png" alt="line.png" class="big-circle-line">
                                <a href="<?php echo $category[4]['friendly_url']; ?>"><?php echo $category[4]['category_name']; ?></a>
                            </div>
                            <!--</div>-->
                        </div>
                        <div class="category-box c-box-6 animate__animated animate__fadeInUp animate__delay-1s">
                            <div class="circle-relative">
                                 <img src="<?php echo DESIGN_URL; ?>assets/images/oval/cat-6/circle.png" alt="" class="big-circle">
                                 <img src="<?php echo DESIGN_URL; ?>assets/images/oval/cat-6/icon.png" alt="" class="big-circle-icon">
                                 <img src="<?php echo DESIGN_URL; ?>assets/images/oval/cat-6/line.png" alt="line.png" class="big-circle-line">
                                <a href="<?php echo $category[5]['friendly_url']; ?>"><?php echo $category[5]['category_name']; ?></a>
                            </div>
                        </div>
                        <div class="category-box c-box-7 animate__animated animate__fadeInUp animate__delay-3s">
                            <div class="circle-relative">
                                 <img src="<?php echo DESIGN_URL; ?>assets/images/oval/cat-7/circle.png" alt="" class="big-circle">
                                 <img src="<?php echo DESIGN_URL; ?>assets/images/oval/cat-7/icon.png" alt="" class="big-circle-icon">
                                 <img src="<?php echo DESIGN_URL; ?>assets/images/oval/cat-7/line.png" alt="line.png" class="big-circle-line">
                                <a href="<?php echo $category[6]['friendly_url']; ?>"><?php echo $category[6]['category_name']; ?></a>
                            </div>
                        </div>
                        <div class="category-box c-box-8 animate__animated animate__fadeInUp animate__delay-3s">
                            <div class="circle-relative">
                                 <img src="<?php echo DESIGN_URL; ?>assets/images/oval/cat-8/circle.png" alt="" class="big-circle">
                                 <img src="<?php echo DESIGN_URL; ?>assets/images/oval/cat-8/icon.png" alt="" class="big-circle-icon">
                                 <img src="<?php echo DESIGN_URL; ?>assets/images/oval/cat-8/line.png" alt="line.png" class="big-circle-line">
                                <a href="<?php echo $category[7]['friendly_url']; ?>"><?php echo $category[7]['category_name']; ?></a>
                            </div>
                        </div>
                        <div class="category-box c-box-9 animate__animated animate__fadeInUp animate__delay-4s">
                            <div class="circle-relative">
                                 <img src="<?php echo DESIGN_URL; ?>assets/images/oval/cat-9/circle.png" alt="" class="big-circle">
                                 <img src="<?php echo DESIGN_URL; ?>assets/images/oval/cat-9/icon.png" alt="" class="big-circle-icon">
                                 <img src="<?php echo DESIGN_URL; ?>assets/images/oval/cat-9/line.png" alt="line.png" class="big-circle-line">
                                <a href="<?php echo $category[8]['friendly_url']; ?>"><?php echo $category[8]['category_name']; ?></a>
                            </div>
                        </div>
                        <div class="category-box c-box-10 animate__animated animate__fadeInUp animate__delay-5s">
                            <div class="circle-relative">
                                 <img src="<?php echo DESIGN_URL; ?>assets/images/oval/cat-10/circle.png" alt="" class="big-circle">
                                 <img src="<?php echo DESIGN_URL; ?>assets/images/oval/cat-10/icon.png" alt="" class="big-circle-icon">
                                 <img src="<?php echo DESIGN_URL; ?>assets/images/oval/cat-10/line.png" alt="line.png" class="big-circle-line">
                                <a href="<?php echo $category[9]['friendly_url']; ?>"><?php echo $category[9]['category_name']; ?></a>
                            </div>
                        </div>
                        <div class="category-box-center">
                            <div class="circle-main-relative">
                                 <img src="<?php echo DESIGN_URL; ?>assets/images/oval/mid-round2.png" alt="">
                                <a href="<?php echo base_url().'view-all-category'; ?>">All<br>Categories</a>
                            </div>
                        </div>
                        <div class="category-box-line-1">
                             <img src="<?php echo DESIGN_URL; ?>assets/images/oval/lines/left-line-5.png" alt="" class="line">
                        </div>
                        <div class="category-box-line-2">
                             <img src="<?php echo DESIGN_URL; ?>assets/images/oval/lines/left-line-4.png" alt="" class="line">
                        </div>
                        <div class="category-box-line-3">
                             <img src="<?php echo DESIGN_URL; ?>assets/images/oval/lines/left-line-3.png" alt="" class="line">
                        </div>
                        <div class="category-box-line-4">
                             <img src="<?php echo DESIGN_URL; ?>assets/images/oval/lines/left-line-2.png" alt="" class="line">
                        </div>
                        <div class="category-box-line-5">
                             <img src="<?php echo DESIGN_URL; ?>assets/images/oval/lines/left-line-1.png" alt="" class="line">
                        </div>
                        <div class="category-box-line-6">
                             <img src="<?php echo DESIGN_URL; ?>assets/images/oval/lines/line-5.png" alt="" class="line">
                        </div>
                        <div class="category-box-line-7">
                             <img src="<?php echo DESIGN_URL; ?>assets/images/oval/lines/line-4.png" alt="" class="line">
                        </div>
                        <div class="category-box-line-8">
                             <img src="<?php echo DESIGN_URL; ?>assets/images/oval/lines/line-3.png" alt="" class="line">
                        </div>
                        <div class="category-box-line-9">
                             <img src="<?php echo DESIGN_URL; ?>assets/images/oval/lines/line-2.png" alt="" class="line">
                        </div>
                        <div class="category-box-line-10">
                             <img src="<?php echo DESIGN_URL; ?>assets/images/oval/lines/line-1.png" alt="" class="line">
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section class="home-product-slider">
                <div class="container-fluid">
                    <!-- Swiper -->
                    <h2 class="title justify-content-center pt-1 ls-normal mb-5">Featured Products</h2>
                    <div class="swiper product-swiper">
                        <div class="swiper-wrapper">
                            
                            <?php
                            // print_r($featured_product);
                            foreach($featured_product as $fp=>$ffp)
                            {
                                $name=$ffp['product_name'];
                                if (strlen($name) > 20)
                                {
                                ...
                                <div class="product-wrap">
                                    <div class="product text-center">
                                        <figure class="product-media">
                                            <a href="<?php echo base_url().$ffp['friendly_url'];?>">
                                                 <img src="<?php echo base_url().'uploaded-files/products/'.$ffp['media']; ?>" alt="Product" width="300"
                                                    height="338">
                                            </a>
                                            <!--<div class="product-action-vertical">-->
                                            <!--    <a href="<?php echo base_url().$ffp['friendly_url'];?>" onclick="" class="btn-product-icon btn-cart w-icon-cart"-->
                                            <!--        title="Add to cart"></a>-->
                                            <!--    <a href="<?php echo base_url().$ffp['friendly_url'];?>" onclick="" class="btn-product-icon btn-wishlist w-icon-heart"-->
                                            <!--        title="Add to wishlist"></a>-->
                                            <!--</div>-->
                                        </figure>
                                        <div class="product-details">
                                            <h4 class="product-name"> <a href="<?php echo base_url().$ffp['friendly_url'];?>">
                                                ₹ <?php echo ucwords(htmlspecialchars_decode($ffp['product_discounted_price'])); ?></a>
                                            </h4>
                                            <div class="product-price">
                                                <span class="price"><?php echo $name; ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <section class="rec-banner">
                <div class="container-fluid">
                    <div class="recom-banner-mobile">
                         <img src="<?php echo DESIGN_URL; ?>assets/images/banner-bg.jpg" alt="">
                        <div class="recom-banner-con">
                            <h1>Banner Title</h1>
                            <a href="#!">Shop Now</a>
                        </div>
                    </div>
            ...
            <section>
                <div class="container-fluid">
                    <h2 class="title justify-content-center pt-1 ls-normal mb-5">Recommended For You</h2>
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-12 d-xs-none">
                            <div class="recom-banner">
                                 <?php
                    foreach($allbanners as $ab=>$slider)
                    {
                        if($slider['banner_position']=='Recommended For You 1')
                        {
                ?>
                                 <img src="<?php echo base_url(),'uploaded-files/banner/'.$slider['banner_image']; ?>" alt="">
                                 <?php  }}?>
                        ...
                        <div class="col-lg-9 col-md-9 col-sm-12">
                            <div class="row">
                                  ...
                                  <?php
                            // print_r($new_products_arrival);
                            foreach($new_products_arrival as $fp=>$ffp)
                            {
                                $name=$ffp['product_name'];
                                if (strlen($name) > 20)
                                {
                                ...
                                <div class="col-lg-3 col-md-3 col-xs-6 mb-2">
                                    <div class="product-wrap">
                                        <div class="product text-center">
                                            ...
                                            <div class="product-details">
                                                <h4 class="product-name"><a href="#">₹ <?php echo ucwords(htmlspecialchars_decode($ffp['product_discounted_price'])); ?></a></h4>
                                                <div class="product-price">
                                                    <span class="price"><?php echo $name; ?></span>
                                                </div>
                                            </div>
            ...
            <section class="promotional-banner">
                <div class="container-fluid">
                    ...
                    foreach($allbanners as $ab=>$slider)
                    {
                        if($slider['banner_position']=='Index Bottom 1')
                        {
                ?>  
                        ...
                        <?php  } } ?>
                         ...
                         foreach($allbanners as $ab=>$slider)
                    {
                        if($slider['banner_position']=='Index Bottom 2')
                        {
                    ...
                    <div class="row">
                                ...
                                <div class="feature-bx-img">
                                    <svg id="_003-scooter" data-name="003-scooter" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <path id="Path_3267" data-name="Path 3267"
                                            ...
                                            transform="translate(-47.033 -11.307)" fill="#171717"></path>
                                        <path id="Path_3268" data-name="Path 3268"
                                            ...
                                            transform="translate(-38.869 -18.132)" fill="#171717"></path>
                                        <path id="Path_3269" data-name="Path 3269"
                                            ...
                                            transform="translate(-23.386 -20.539)" fill="#171717"></path>
                                        <path id="Path_3270" data-name="Path 3270"
                                            ...
                                            transform="translate(-25.643 -20.538)" fill="#171717"></path>
                                        ...
                                        <path id="Path_3273" data-name="Path 3273"
                                            ...
                                            transform="translate(26.691 -22.714)" fill="#171717"></path>
                                        <path id="Path_3274" data-name="Path 3274"
                                            ...
                                            transform="translate(21.302 -20.535)" fill="#171717"></path>
                                        <path id="Path_3275" data-name="Path 3275"
                                            ...
                                            transform="translate(9.301 -15.887)" fill="#171717"></path>
                                        ...
                                        <path id="Path_3278" data-name="Path 3278"
                                            ...
                                            transform="translate(25.366 -24.044)" fill="#171717"></path>
                                    </svg>
                                </div>
                                <div class="feature-cont">
                                  <a href="<?php echo  base_url().'free-shipping'; ?>">  <h1>Free Shipping</h1></a>
                                ...
                                <div class="feature-bx-img">
                                    <svg id="_004-return" data-name="004-return" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <path id="Path_3279" data-name="Path 3279"
                                            ...
                                            transform="translate(-241.198 -358.423)" fill="#171717"></path>
                                        <path id="Path_3280" data-name="Path 3280"
                                            ...
                                            transform="translate(-374.997 -358.423)" fill="#171717"></path>
                                        <path id="Path_3281" data-name="Path 3281"
                                            ...
                                            transform="translate(-291.586 -369.69)" fill="#171717"></path>
                                        <path id="Path_3282" data-name="Path 3282"
                                            ...
                                            transform="translate(-92.345 -0.001)" fill="#171717"></path>
                                        <path id="Path_3283" data-name="Path 3283"
                                            ...
                                            transform="translate(0 -199.595)" fill="#171717"></path>
                                    </svg>
                                </div>
                                <div class="feature-cont">
                                    <a href="<?php echo  base_url().'easy-returns'; ?>"><h1>Easy Returns</h1></a>
                                    ...
                                    <svg id="_001-payment-security" data-name="001-payment-security"
                                        ...
                                        <g id="Group_2181" data-name="Group 2181" transform="translate(0 0)">
                                            ...
                                            <path id="Path_3251" data-name="Path 3251"
                                                ...
                                                transform="translate(-264.227 -180.334)" fill="#171717"></path>
                                            <path id="Path_3252" data-name="Path 3252"
                                                ...
                                                transform="translate(-319.819 -180.334)" fill="#171717"></path>
                                            <path id="Path_3253" data-name="Path 3253"
                                                ...
                                                transform="translate(-375.411 -180.334)" fill="#171717"></path>
                                            <path id="Path_3254" data-name="Path 3254"
                                                ...
                                                transform="translate(-0.003 0)" fill="#171717"></path>
                                            <path id="Path_3255" data-name="Path 3255"
                                                ...
                                                transform="translate(-320.103 -53.002)" fill="#171717"></path>
                                        </g>
                                    </svg>
                                </div>
                                <div class="feature-cont">
                                    <a href="<?php echo  base_url().'secure-payment'; ?>"><h1>Secure Payment</h1></a>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 mb-3">
                            <div class="feature-bx">
                                            ...
                                            <g id="Group_2248" data-name="Group 2248"
                                                ...
                                                <g id="Group_2247" data-name="Group 2247">
                                                    <path id="Path_3446" data-name="Path 3446"
                                                        ...
                                                        transform="translate(-226.694 -78.832)" fill="#171717"></path>
                                                </g>
                                            </g>
                                            <g id="Group_2250" data-name="Group 2250" transform="translate(43.008)">
                                                <g id="Group_2249" data-name="Group 2249" transform="translate(0)">
                                                    <path id="Path_3447" data-name="Path 3447"
                                                        ...
                                                        transform="translate(-43.008 0)" fill="#171717"></path>
                                                </g>
                                            </g>
                                            <g id="Group_2252" data-name="Group 2252"
                                                ...
                                                <g id="Group_2251" data-name="Group 2251" transform="translate(0)">
                                                    <path id="Path_3448" data-name="Path 3448"
                                                        ...
                                                        transform="translate(-386.517 -56.22)" fill="#171717"></path>
                                                </g>
                                            </g>
                                        </g>
                                    </svg>
                                ...
                                <div class="feature-cont">
                                    <a href="<?php echo  base_url().'contact-us'; ?>"><h1>Special Support</h1></a>
