          ...
          <div class="statbox widget box box-shadow">
            ...
            <div class="widget-content widget-content-area">
              <div class="table-responsive mb-4">
                  ...
                  <?php echo form_open_multipart(base_url().'wps-admin/top-ten-link/add/action','class="row"') ?>
                        ...
                        <div class="col-md-2">  <label>Link<span class="text-danger">*</span></label></div>

                        <div class="col-md-4">
                          <div class="form-group">
                             
                              <textarea name="link" class="form-control" placeholder="Description here..." required=""></textarea>
                          </div></div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td><img src="<?php echo base_url().'uploaded-files/topten/'.$d['image']; ?>" HEIGHT="30px"></td>
                                <td><a href="<?php echo ['link']; ?>">Goto Link</a></td>
                                <td>
                                  <a href="<?php echo base_url().'admin/edit/top-ten-link/'.$d['id']; ?>" class="btn btn-info"><i class="fa fa-edit"></i></a>
                                  <a href="<?php echo base_url().'admin/delete/top-ten-link/'.$d['id']; ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                </td>
                              </tr>
