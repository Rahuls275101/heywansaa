            ...
            <div class="widget-header">
              <div class="row">
                <div class="col-xl-8 col-md-8 col-sm-8 col-8">
                  <h4><?php echo $headingTitle.'('.count($data).')'; ?></h4>
                </div>
                      ...
                      foreach ($data as $d ) 
                      {
                        ...
                        <tr>
                            ...
                            <td colspan="4">
                                ...
                                <?php echo form_open(base_url()."wps-admin/bulkorder_old/action_update_bulk_status/0"); ?>
                                ...
                                <select name="status" class="form-control" required>
                                    ...
                                    <option value="1">Update as New Bulk Border</option>
