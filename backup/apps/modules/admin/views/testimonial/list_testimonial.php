            ...
            <div class="widget-header">
              <div class="row">
                ...
                <div class="col-xl-6 col-md-6 col-sm-6 col-6 text-right">
                  <a href="<?php echo base_url().'wps-admin/add/testimonial'; ?>" class="btn btn-primary" >Add New</a>
                </div>
            ...
            <table id="style-3" class="table style-3  table-hover">
                <thead>
                    ...
                    <tbody>
                      ...
                      $c=1;
                      $ttl_debt=0;
                      foreach ($res as $catKey) {
                        
                        ?> 
                        <tr>

                          <td><?=$c++?></td>
                          <td><? $catKey->poster_name?></td>
                          <td><?=$catKey->testimonial_title?></td>
                          <td><?=$catKey->testimonial_description?></td>
                          <td><img src="<?= base_url().'uploaded-files/testimonial/'.$catKey->testimonial_image?>" height="40px"></td>
                          <td>
                              <a href="<?php echo base_url().'wps-admin/delete/testimonial/'.$catKey->testimonial_id; ?>" class="btn btn-danger" title="Delete"><i class="fa fa-trash"></i></a>
