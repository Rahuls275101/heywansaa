            ...
            <div class="widget-header">
              <div class="row">
                ...
                <div class="col-xl-6 col-md-6 col-sm-6 col-6 text-right">
                  <h4>
                    <a href="<?php echo base_url(); ?>wps-admin/size/" class="btn btn-danger btn-sm mb-2"><i class="fa fa-exclamation-circle"></i> Cancel</a>
            ...
            <div class="widget-content widget-content-area">
              <div class="table-responsive mb-4">
                ...
                <div class="form-group row  mb-4">
                  <label class="col-sm-3 col-form-label col-form-label-sm"><span class="red">*</span>Size Name</label>
                  <div class="col-sm-6">
