            ...
            <div class="widget-content widget-content-area">
              <div class="table-responsive mb-4">
                ...
                <div class="form-group row  mb-4">
                  ...
                  <div class="col-sm-6">
                    <div id="ban_postion">
                      <?php echo banner_postion_drop_down('banner_position', $this->input->post('banner_position'), $this->input->post('section'), 'class="form-control required"'); ?>
                ...
                <div class="form-group row  mb-4">
                  <label class="col-sm-3 col-form-label col-form-label-sm" for="bannerImage"><span class="red">*</span>Banner</label>
                  <div class="col-sm-6">
                ...
                <div class="form-group row  mb-4">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" id="banner_title" name="banner_title" value="<?php echo set_value('banner_title'); ?>" placeholder="Banner Title" required /><?php echo form_error('banner_title'); ?>
                  </div>
                </div>
                <div class="form-group row  mb-4">
                  <label class="col-sm-3 col-form-label col-form-label-sm" for="categoryName"><span class="red">*</span>URL</label>
                  <div class="col-sm-6">
                    <input type="text" class="form-control" id="banner_url" name="banner_url" value="<?php echo set_value('banner_url'); ?>" placeholder="Banner URL" required /><?php echo form_error('banner_url'); ?>
                  </div>
                </div>
