            ...
            <div class="widget-content widget-content-area">
              <div class="table-responsive mb-4">
                ...
                if (is_array($res) && !empty($res)) {
                  echo form_open(base_url() . "wps-admin/meta/", 'id="data_form"');
                  ?>
                      ...
                      foreach ($res as $catKey => $pageVal) {
                        ...
                        <tr>
                          <td class="checkbox-column text-left"> 
                            <label class="new-control new-checkbox checkbox-outline-info  m-auto">
                              <input type="checkbox" type="checkbox" name="arr_ids[]" value="<?php echo $pageVal['meta_id']; ?>" class="new-control-input child-chk select-customers-info">
                              <span class="new-control-indicator"></span><span style="visibility:hidden">c</span>
                            </label>                            
                          </td>
                          <td>
                            <?php echo $pageVal['page_url']; ?>
                          </td>
                          <td>
                          ...
                          <td>
                            <a href="<?php echo base_url(); ?>wps-admin/meta/edit/<?php echo $pageVal['meta_id']; ?>" class="btn btn-success btn-sm mb-2">Edit</a>
                          </td>
                        </tr>
