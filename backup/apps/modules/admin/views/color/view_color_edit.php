            ...
            <div class="widget-content widget-content-area">
              <div class="table-responsive mb-4">
                ...
                <div class="form-group row  mb-4">
                  ...
                  <div class="col-sm-6">
                  <input type="color" name="color_code" class="form-control my-colorpicker1 colorpicker-element "  value="<?php echo set_value('color_code',$edit_result['color_code']);?>">
              ...
              <div class="widget-header">
                <div class="row">
                  ...
                  <div class="col-xl-6 col-md-6 col-sm-6 col-6 text-right">
                    <h4>
                      <a href="<?php echo base_url(); ?>wps-admin/color/" class="btn btn-danger btn-sm mb-2"><i class="fa fa-exclamation-circle"></i> Cancel</a>
                      <input type="hidden" class="form-control" name="sub" value="Update" />
                      <button type="submit" class="btn btn-primary btn-sm mb-2"><i class="fa fa-plus"></i> Update</button>
