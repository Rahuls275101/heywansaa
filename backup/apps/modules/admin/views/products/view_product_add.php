      ...
      <div class="row layout-top-spacing layout-spacing">
        <div class="col-lg-12">
          <div class="statbox widget box box-shadow">
            <?php
            echo form_open_multipart('wps-admin/products/add/', 'id="data_form"');
              ...
              <div class="col-md-2">
                ...
                <div class="form-group row  mb-4">
                  ...
                  <div class="col-sm-6 row">
                    <div class="col-sm-6">
                    <input id="product_price" name="product_price" value="<?php echo set_value('product_price'); ?>" type="text" required class="form-control"><?php echo form_error('product_price'); ?>
                    <label for="product_code"><span class="required">*</span>Product Price</label>
                    </div>
                    <div class="col-sm-6">
                    <input id="unit_value" name="discounted_price" value="<?php echo set_value('discounted_price'); ?>" type="text" required class="form-control"><?php echo form_error('discounted_price'); ?>
                ...
                <div class="form-group row  mb-4">
                  ...
                  <div class="col-sm-6 row">
                        <div class="col-sm-6">
                        <input id="product_code" name="product_code" value="<?php echo set_value('product_code'); ?>" type="text" class="form-control" required><?php echo form_error('product_code'); ?>
                        <label for="product_code"><span class="required">*</span>Product Code</label>
                        </div>
                        <div class="col-sm-6">
                        <input id="product_qty" name="product_qty" value="<?php echo set_value('product_qty'); ?>" type="text" class="form-control" required><?php echo form_error('product_qty'); ?>
