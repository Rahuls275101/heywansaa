            ...
            <div class="widget-header">
              <div class="row">
                ...
                <div class="col-xl-4 col-md-4 col-sm-4 col-4 text-right">
                  <h4><a href="<?php echo base_url(); ?>wps-admin/subloccontent/add" class="btn btn-dark btn-sm mb-2"><i class="fa fa-plus"></i> Add New Content</a></h4>
                </div>
              </div>
            </div>
            <div class="widget-content widget-content-area">
              <div class="table-responsive mb-4">
                ...
                if (is_array($res) && !empty($res)) {
                  echo form_open(base_url() . "wps-admin/subloccontent/", 'id="data_form"');
                  ?>
                  <table id="style-3" class="table style-3  table-hover">
                    ...
                    <tbody>
                      ...
                      foreach ($res as $catKey => $pageVal) {
                        $imgdisplay = FALSE;
                        $cat = explode(',',$pageVal['location_id']);
                      ...
                      <td class="left">
                        <?php echo $pageVal['short_description']; ?>
                          ...
                          <td>
                            <a href="<?php echo base_url(); ?>wps-admin/subloccontent/edit/<?php echo $pageVal['subcontentId']; ?>" class="btn btn-success btn-sm mb-2">Edit</a>
                          </td>
                        </tr>
