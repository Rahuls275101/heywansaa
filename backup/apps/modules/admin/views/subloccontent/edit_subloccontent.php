            ...
            <div class="widget-content widget-content-area">
              ...
              <?php echo form_error('location_id'); ?>
                ...
                <div class="form-group row  mb-4">
                  ...
                  <div class="col-sm-6">
                  <textarea class="form-control" name="description" id="description"><?php echo set_value('description',$res['description']); ?></textarea><?php echo form_error('description'); ?><?php echo display_ckeditor($ckeditor); ?><b style="color:#660000;">Contrary to {location} belief.</b>
                  </div>
                </div>
                ...
                <div class="form-group row  mb-4">
                  ...
                  <div class="col-sm-6">
                    <div id="ban_postion">
                    <textarea class="form-control" name="short_description" id="short_description"><?php echo set_value('short_description',$res['short_description']); ?></textarea><?php echo form_error('short_description'); ?><b style="color:#660000;">Contrary to {location} belief.</b>
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group row  mb-4">
                  ...
                  <div class="col-sm-6">
                    <div id="ban_postion">
                    <textarea class="form-control" name="meta_keyword" rows="5" cols="80" id="keyword" ><?php echo set_value('meta_keyword',$res['meta_keyword']); ?></textarea><?php echo form_error('meta_keyword'); ?><b style="color:#660000;">Manufacturer in {location}</b>
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group row  mb-4">
                  ...
                  <div class="col-sm-6">
                    <div id="ban_postion">
                    <textarea class="form-control" name="meta_description" rows="5" cols="80" id="description" ><?php echo set_value('meta_description',$res['meta_description']); ?></textarea><?php echo form_error('meta_description'); ?><b style="color:#660000;">Manufacturer in {location}</b>
                    </div>
                  </div>
                </div>
