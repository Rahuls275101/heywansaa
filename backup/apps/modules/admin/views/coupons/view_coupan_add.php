            ...
            <div class="widget-content widget-content-area">
              <div class="table-responsive mb-4">
                ...
                <div class="form-group row  mb-4">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="cpn_name" id="cpn_name" placeholder="" class="form-control" value="<?php echo set_value('cpn_name'); ?>"><?php echo form_error('cpn_name'); ?>
                  </div>
                </div>
                <div class="form-group row  mb-4">
                ...
                <div class="form-group row  mb-4">
                  ...
                  <div class="col-md-6 col-xs-12">                                         
                    <input type="text" name="cpn_rate" id="cpn_rate" placeholder="" class="form-control" value="<?php echo set_value('cpn_rate'); ?>"><?php echo form_error('cpn_rate'); ?>
                  </div>
                </div>
                <div class="form-group row  mb-4">
                  ...
                  <div class="col-md-6 col-xs-12">                                         
                  <input type="text" name="minimum_amount_for_coupan_apply" class="form-control" value="<?php echo set_value('minimum_amount_for_coupan_apply');?>">  <?php echo form_error('minimum_amount_for_coupan_apply'); ?>
                  </div>
                </div>
                <div class="form-group row  mb-4">
                  <label class="col-sm-3 col-form-label col-form-label-sm" for="cpn_code">Coupan Code <span class="red">*</span></label>
                  <div class="col-md-6">                                                                                                                                                        
                    <input type="text" name="cpn_code" id="cpn_code" placeholder="" class="form-control" value="<?php echo set_value('cpn_code'); ?>"><?php echo form_error('cpn_code'); ?>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-xl-6 col-md-6 col-sm-6 col-6 text-right">
                    <h4>
                      <a href="<?php echo base_url(); ?>wps-admin/discountcoupon" class="btn btn-danger btn-sm mb-2"><i class="fa fa-exclamation-circle"></i> Cancel</a>
                      <button type="submit" class="btn btn-primary btn-sm mb-2"><i class="fa fa-plus"></i> Save</button>
                      <input type="hidden" name="sbmt_cpn" value="sbmt_cpn" /> 
                    </h4>
                  </div>
                </div>
              </div>
