            ...
            <div class="widget-header">
              <div class="row">
                ...
                <div class="col-xl-4 col-md-4 col-sm-4 col-4 text-right">
                  <h4><a href="<?php echo base_url(); ?>wps-admin/location/state_add/" class="btn btn-dark btn-sm mb-2"><i class="fa fa-plus"></i> Add New State</a></h4>
                </div>
              </div>
            </div>
            <div class="widget-content widget-content-area">
              <div class="table-responsive mb-4">
                ...
                if (is_array($res) && !empty($res)) {
                  echo form_open(base_url() . "wps-admin/location/state", 'id="data_form"');
                  ?>
                    ...
                    <tbody>
                      ...
                      foreach ($res as $catKey => $pageVal) {
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="<?php echo base_url(); ?>wps-admin/location/state_edit/<?php echo $pageVal['id']; ?>" class="btn btn-success btn-sm mb-2">Edit</a>
                          </td>
                        </tr>
