          ...
          <div class="statbox widget box box-shadow">
            ...
            <div class="widget-header">
              <div class="row">
                ...
                <div class="col-xl-4 col-md-4 col-sm-4 col-4 text-right">
                  <h4><a href="<?php echo base_url(); ?>wps-admin/category/add/<?php echo $parent_id; ?>" class="btn btn-dark btn-sm mb-2"><i class="fa fa-plus"></i> Add New Category</a></h4>
                </div>
              </div>
            </div>
            <div class="widget-content widget-content-area">
              <div class="table-responsive mb-4">
                ...
                if (is_array($res) && !empty($res)) {
                  echo form_open(base_url() . "wps-admin/category/", 'id="data_form"');
                  ?>
                      ...
                      foreach ($res as $catKey => $pageVal) {
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <?php
                            echo "<br><br>" . anchor("wps-admin/category/index/" . $pageVal['category_id'], 'Subcategory [' . $total_subcategory . ']', 'style="color:#2196f3;" ');
                            echo " | " . anchor("wps-admin/products/index/" . $pageVal['category_id'], 'Products [' . $total_products . ']', 'style="color:#2196f3;" ');

                            if ($pageVal['home_menu'] == '0') {
                              echo " | " . anchor("wps-admin/category/index/?set_shop_category=" . $pageVal['category_id'], 'Set As Shop By Categories', 'style="color:#2196f3;" ');
                            } else {
                              echo " | " . anchor("wps-admin/category/index/?unset_shop_category=" . $pageVal['category_id'], 'Unset As Shop By Categories', 'style="color:#2196f3;" ');
                            }
                            if ($pageVal['home_cat'] == '0') {
                              echo " | " . anchor("wps-admin/category/index/?set_home_category=" . $pageVal['category_id'], 'Set As Home Category', 'style="color:#2196f3;" ');
                            } else {
                              echo " | " . anchor("wps-admin/category/index/?unset_home_category=" . $pageVal['category_id'], 'Unset As Home Category', 'style="color:#2196f3;" ');
                            }
                            ?>
                          </td>
                          <td>
                          ...
                          <td class="text-center">
                            <a href="<?php echo base_url(); ?>wps-admin/category/edit/<?php echo $pageVal['category_id']; ?>" class="btn btn-success btn-sm mb-2">Edit</a>
                          </td>
                        </tr>
                        <?php
                      }
