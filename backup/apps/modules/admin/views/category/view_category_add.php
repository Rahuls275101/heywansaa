              ...
              <div class="row">
                ...
                <div class="col-xl-6 col-md-6 col-sm-6 col-12 text-right">
                  ...
                  <h4>
                    ...
                    <a href="<?php echo base_url(); ?>wps-admin/category/index/<?php echo $parent_id; ?>" class="btn btn-danger btn-sm mb-2"><i class="fa fa-exclamation-circle"></i> Cancel</a>
                ...
                <div class="row">
                  ...
                  <div class="col-xl-6 col-md-6 col-sm-6 col-12 text-right">
                    ...
                    <h4>
                      ...
                      <a href="<?php echo base_url(); ?>wps-admin/category" class="btn btn-danger btn-sm mb-2"><i class="fa fa-exclamation-circle"></i> Cancel</a>
