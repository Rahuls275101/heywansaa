...
class Bulkorder_dispatch extends Admin_Controller
{
    ...
    //   print_r($this->input->post());
        ...
        if($this->form_validation->run())
        {
            ...
            if($this->bulkmodel->update_where($tb,$data,$where))
            {
                    ...
                    redirect('wps-admin/bulkorder_dispatch');
            }
            else
            {
