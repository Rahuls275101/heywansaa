...
class Dashboard extends Admin_Controller {
  ...
  public function changepassword() 
  {
    ...
    $this->form_validation->set_rules('admin_margin', 'Admin Margin', 'required|max_length[80]');
    ...
    if ($this->form_validation->run() == TRUE) {
      ...
      $this->admin_model->update_info($this->input->post('old_pass'), '1',$this->input->post('admin_margin'));
