...
?> <main class="main">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="mobile-category-block">
                                    <a href="#!">
                                          <img src="<?php echo DESIGN_URL; ?>assets/images/menu/seller.png" alt="">
                            ...
                            <div class="swiper-slide">
                                <div class="mobile-category-block">
                                    <a href="#!">
                                          <img src="<?php echo DESIGN_URL; ?>assets/images/menu/reward.png" alt="">
                                        <h3>Rewards Point</h3>
                                    </a>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="mobile-category-block">
                                    <a href="#!">
                                          <img src="<?php echo DESIGN_URL; ?>assets/images/menu/purchased.png" alt="">
                            ...
                            <div class="swiper-slide">
                                <div class="mobile-category-block">
                                    <a href="#!">
                                          <img src="<?php echo DESIGN_URL; ?>assets/images/menu/deals.png" alt="">
                                        <h3>Today's Deal</h3>
                                    </a>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="mobile-category-block">
                                    <a href="#!">
                                          <img src="<?php echo DESIGN_URL; ?>assets/images/menu/bulk-order.png" alt="">
                                        <h3>Bulk Order</h3>
                                    </a>
                                </div>
                            </div>
            ...
            <section class="oval-back">
                ...
                <div class="container-fluid">
                    <div class="category-main-box">
                        ...
                        <div class="category-box c-box-7 animate__animated animate__fadeInUp animate__delay-2s">
                            <div class="circle-relative">
                                ...
                                <div class="product-wrap">
                                    <div class="product text-center">
                                        ...
                                        <div class="product-details">
                                            <h4 class="product-name"><a href="#">₹ <?php echo ucwords(htmlspecialchars_decode($ffp['product_discounted_price'])); ?></a>
                                            </h4>
            ...
            <section>
                <div class="container-fluid d-none">
                    <!-- <h2 class="title justify-content-center pt-1 ls-normal mb-5">Previously You Bought</h2> -->
                    <div class="container-fluid">
                        <!-- Swiper -->
                        <h2 class="title justify-content-center pt-1 ls-normal mb-5">Previously You Bought</h2>
                        <div class="swiper previouslyBought">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="product-wrap">
                                        <div class="product text-center">
                                            <figure class="product-media">
                                                <a href="product-default.html">
                                                     <img src="<?php echo DESIGN_URL; ?>assets/images/products/3-10.jpg" alt="Product" width="300"
                                                        height="338">
                                                </a>
                                                <div class="product-action-vertical">
                                                    <a href="#" class="btn-product-icon btn-cart w-icon-cart"
