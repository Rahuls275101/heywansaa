...
<main class="main login-page">
  ...
  <nav class="breadcrumb-nav">
      <div class="container">
          <ul class="breadcrumb">
              <h1 class="page-title mb-0">Vendor Forgot Password</h1>
              <li><a href="<?php echo base_url(); ?>">Home</a></li>
              <li>Vendor Forgot Password</li>
          </ul>
      </div>
  </nav>
  <!-- End of Breadcrumb -->
      ...
      <div class="container">
          <div class="login-popup">
              <div class="tab-content">
                  <form method="post"  class="tab-pane active"  action="<?php echo base_url().'registartion/resetpassword' ?>">
